...
public class Testes3 implements Initializable{
	
	@FXML
	private TableView<Registro> tbRegistrosDep1;
	@FXML
	...
	private List<Registro> listRegistrosDep1 = new ArrayList<>();
	private ObservableList<Registro> observableListRegistrosDep1;
	...
	public void getRegistros() {
		...
		observableListRegistrosDep1 =  FXCollections.observableArrayList(listRegistrosDep1);
		tbRegistrosDep1.setItems(observableListRegistrosDep1);
